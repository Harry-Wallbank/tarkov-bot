  ...
  async execute(interaction) {
    ...
    try {
      ...
      const embed = buildInfoEmbed({
        ...
        footer: 'Greedy per-slot optimizer over Tarkov.dev data. Required slots + stock/foregrip only — optics and other optional slots skipped. Image is the closest existing preset match, not a custom render.',
      });
